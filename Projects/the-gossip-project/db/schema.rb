...
ActiveRecord::Schema.define(version: 2020_05_04_074859) do
    ...
    create_table "private_messages_recipients", force: :cascade do |t|
        t.bigint "private_message_id"
        t.bigint "recipients_id"
        t.index ["private_message_id"], name: "index_private_messages_recipients_on_private_message_id"
        t.index ["recipients_id"], name: "index_private_messages_recipients_on_recipients_id"
    end
